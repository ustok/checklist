...
public class ProtocolPackageImpl extends EPackageImpl implements ProtocolPackage
{
  ...
  public static ProtocolPackage init()
  {
    ...
    ChecklistPackage.eINSTANCE.eClass();
   ...
   * @generated
   */
  public EReference getProtocol_Nodes()
  {
   ...
   * @generated
   */
  public EReference getProtocol_ChecklistModel()
  {
   ...
   * @generated
   */
  public EAttribute getProtocolNode_Status()
  {
   ...
   * @generated
   */
  public EReference getProtocolNode_Step()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEReference(protocolEClass, PROTOCOL__NODES);
    createEReference(protocolEClass, PROTOCOL__CHECKLIST_MODEL);

    protocolNodeEClass = createEClass(PROTOCOL_NODE);
    createEAttribute(protocolNodeEClass, PROTOCOL_NODE__INFO);
    createEAttribute(protocolNodeEClass, PROTOCOL_NODE__STATUS);
    createEReference(protocolNodeEClass, PROTOCOL_NODE__STEP);
  ...
  public void initializePackageContents()
  {
    ...
    ChecklistPackage theChecklistPackage = (ChecklistPackage)EPackage.Registry.INSTANCE.getEPackage(ChecklistPackage.eNS_URI);
    ...
    initEReference(getProtocol_Nodes(), this.getProtocolNode(), null, "nodes", null, 0, -1, Protocol.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getProtocol_ChecklistModel(), theChecklistPackage.getModel(), null, "checklistModel", null, 0, 1, Protocol.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getProtocolNode_Status(), this.getStatus(), "status", null, 0, 1, ProtocolNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getProtocolNode_Step(), theChecklistPackage.getStep(), null, "step", null, 0, 1, ProtocolNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    addEEnumLiteral(statusEEnum, Status.OK);
